...
Some more examples: "halo 4", "red"... however, these don't return related results as there is nothing related in our list using the "related" definition of TasteKid.
